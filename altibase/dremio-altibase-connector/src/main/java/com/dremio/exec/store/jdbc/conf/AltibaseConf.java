 ...
 */
@SourceType(value = "ALTIBASE", label = "Altibase", uiConfig = "altibase-layout.json")
public class AltibaseConf extends AbstractArpConf<AltibaseConf> {
  private static final String ARP_FILENAME = "arp/implementation/altibase-arp.yaml";
  ...
  public String toJdbcConnectionString() {
    ...
    return String.format("jdbc:Altibase://%s", database);
  }
